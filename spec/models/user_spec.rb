...
describe User do
  ...
  describe "password encryption" do
    ...
    describe "has_password? method" do
      ...
      it "shoul return true if the password match" do
        @user.has_password?(@attr[:password]).should be_true
      end
    
      it "shoud return false if the password don't match" do
  ...
  describe "relationships" do
    ...
    it "should have a relationships methode" do
    ...
    it "should have a fallowers method" do
      @user.should respond_to(:followers)
    end
    
    it "should include the fallower in the fallower array" do
      @user.follow!(@followed)
