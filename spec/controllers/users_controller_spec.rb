...
describe UsersController do
  ...
  describe "GET 'index'" do
    ...
    describe "for sign-in-users" do
      ...
      it "should note have a delete links for non-admins" do
        other_user = User.all.second
        get :index
  ...
  describe "Get 'show'" do
    ...
    it "should show the user's microposts" do
      ...
      mp2 = Factory(:micropost, :user  => @user, :content => " bar dene")
      get :show, :id => @user
  ...
  describe "POST 'create" do
    ...
    describe "success" do
      before(:each) do
        @attr = { :name => "New User", :email => "user@example.com", :password => "deneme"}
      end
      
      it "shold create user" do
        lambda do
          post :create, :user => @attr
  ...
  describe "auhtentication of edit/update actions" do
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "as non-admin user" do
      ...
      it "should protecgt the acton" do
        test_sign_in(@user)
        delete :destroy, :id => @user
        response.should redirect_to(root_path)
      end
